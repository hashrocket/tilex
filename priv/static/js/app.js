...
require.register("jquery.cookie/jquery.cookie.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "jquery.cookie");
  (function() {
    /*!
...
var _twitter_button = require("./twitter_button");

var _twitter_button2 = _interopRequireDefault(_twitter_button);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
});

require.register("web/static/js/google_analytics.js", function(exports, require, module) {
'use strict';
...
require.register("web/static/js/like.js", function(exports, require, module) {
"use strict";
...
require.register("web/static/js/post_form.js", function(exports, require, module) {
'use strict';
...
var _text_conversion = require('./text_conversion');

var _text_conversion2 = _interopRequireDefault(_text_conversion);
...
var PostForm = function () {
  ...
  _createClass(PostForm, [{
    ...
    key: 'setInitialPreview',
    value: function setInitialPreview() {
    ...
    key: 'updateWordCount',
    value: function updateWordCount() {
      this.$wordCountContainer.html(this.wordCount());
    }
  }, {
    key: 'updateWordLimit',
    value: function updateWordLimit() {
      this.renderCountMessage(this.$bodyWordLimitContainer, this.bodyWordLimit - this.wordCount(), 'word');
    }
  }, {
    key: 'updateTitleLimit',
    value: function updateTitleLimit() {
      this.renderCountMessage(this.$titleCharacterLimitContainer, this.titleCharacterLimit - this.$titleInput.val().length, 'character');
    }
  }, {
    key: 'updatePreviewTitle',
    value: function updatePreviewTitle() {
      this.$previewTitleContainer.html(this.$titleInput.val());
    }
  }, {
    key: 'renderCountMessage',
    value: function renderCountMessage($el, amount, noun) {
      var plural = amount === 1 ? '' : 's';
      $el.toggleClass('negative', amount < 0).text(amount + ' ' + noun + plural + ' available');
    }
  }, {
    key: 'handlePostBodyPreview',
    value: function handlePostBodyPreview(html) {
      this.$postBodyPreview.html(html);
      this.$postBodyPreview.find('pre code').each(function (_index, codeEl) {
        window.hljs.highlightBlock(codeEl);
      });
    }
  }, {
    key: 'observePostBodyInputChange',
    value: function observePostBodyInputChange() {
      var _this = this;

      this.$postBodyInput.on('input', function (e) {
        _this.updateWordCount();
        _this.updateWordLimit();
        _this.textConversion.convert(e.target.value, 'markdown');
      });
    }
  }, {
    key: 'observeTitleInputChange',
    value: function observeTitleInputChange() {
      var _this2 = this;

      this.$titleInput.on('input', function (e) {
        _this2.updateTitleLimit();
        _this2.updatePreviewTitle();
      });
    }
  }, {
    key: 'textConversion',
    value: function textConversion() {
      return new _text_conversion2.default({
...
;require.register("web/static/js/text_conversion.js", function(exports, require, module) {
"use strict";
...
var TextConversion = function () {
  function TextConversion(properties) {
    _classCallCheck(this, TextConversion);
  ...
  _createClass(TextConversion, [{
    ...
    key: "convert",
    value: function convert(text, format) {
      var conversionObject = {};
      conversionObject[format] = text;
      this.channel.push("convert", conversionObject);
    }
  }, {
    key: "observeChannelResponse",
    value: function observeChannelResponse() {
      var _this = this;

      this.channel.on("converted", function (payload) {
        _this.convertedTextCallback(payload.html);
      });
    }
  }]);
...
exports.default = TextConversion;
});

;require.register("web/static/js/tilex.js", function(exports, require, module) {
"use strict";

var _post_form = require("./post_form");
...
$(function () {
  ...
  $(".site_nav__search, .site_nav__about").on("click", ".site_nav__link", function (e) {
    e.preventDefault();
    $(this).closest('li').toggleClass('site_nav--open').find(":input:visible").eq(0).focus();
  });

  new _post_form2.default({
...
require.register("web/static/js/twitter_button.js", function(exports, require, module) {
"use strict";
...
require.alias("jquery.cookie/jquery.cookie.js", "jquery.cookie");
