...
CREATE TABLE public.developers (
    ...
    mcp_api_key character varying(255)
);
...
--
-- Name: developers_mcp_api_key_index; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX developers_mcp_api_key_index ON public.developers USING btree (mcp_api_key);
